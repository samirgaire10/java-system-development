...
//▼ BaseFrameクラスを継承（拡張）し、L0206クラスを作成
public class L0206 extends BaseFrame {
    JButton btnDraw;
    JLabel lblScreen;
    ...
    public static void main(String args [ ]) {
        L0206 myAppli = new L0206("Get Local Host's Information");
        ...
        btnDraw.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ae) {
                try {
	                ...
	                //▼L0206【ネットワークプログラム1の説明】.pdxのP.2を参照
