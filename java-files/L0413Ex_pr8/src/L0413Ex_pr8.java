...
public class L0413Ex_pr8 extends BaseFrame implements Runnable{
	...
	JLabel lblScreen = new JLabel(new ImageIcon("/run/media/samirgaire10/338F-FFD0/kamata/2年生/java/L0413Ex_pr8/img0.gif"));
	...
	public L0413Ex_pr8(String title) {
		...
		for (int i = 0; i < 5; i++){
			icons[i] = new ImageIcon("/run/media/samirgaire10/338F-FFD0/kamata/2年生/java/L0413Ex_pr8/img" + i + ".gif");
			//▼▼自身の環境においてgifファイルが格納されている場所に書き換える
